...
def solve_via_simulated_annealing(
    ...
    for i in range(n_iters):
        if(temperature != 0):
            ...
            next_colors_best = new_new_tweaks(cur_colors, n_max_colors)
            #next_colors_best = tweaks(cur_colors, n_max_colors, G)
            ...
            if (delta_energy <= 0):
                ...
                probability = np.exp((delta_energy * (-1)) / temperature)
